 ...
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/Media/Feed.php';

/**
 * @see Zend_Gdata_YouTube_PlaylistVideoEntry
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/YouTube/PlaylistVideoEntry.php';
