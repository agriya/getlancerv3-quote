 ...
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/Calendar/ListEntry.php';
