 ...
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/App/Extension/Name.php';

/**
 * @see Zend_Gdata_App_Extension_Email
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/App/Extension/Email.php';

/**
 * @see Zend_Gdata_App_Extension_Uri
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Gdata/App/Extension/Uri.php';
