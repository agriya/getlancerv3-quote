...
class Zend_Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if ((null !== $dirs) && !is_string($dirs) && !is_array($dirs)) {            
            require_once APP_PATH.DS."Vendor".DS."Youtube".DS.'Zend/Exception.php';
        ...
        if (!class_exists($class, false) && !interface_exists($class, false)) {
            require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Exception.php';
    ...
    {
        trigger_error(__CLASS__ . '::' . __METHOD__ . ' is deprecated as of 1.8.0 and will be removed with 2.0.0; use Zend_Loader_Autoloader instead', E_USER_NOTICE);
        require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend/Loader/Autoloader.php';
    ...
    {
        if ($once) {
            return include_once APP.'Plugin'.DS.'VideoResources'.DS.'Vendor'.DS.'Youtube'.DS.$filespec;
        } else {
            return include APP.'Plugin'.DS.'VideoResources'.DS.'Vendor'.DS.'Youtube'.DS.$filespec ;
        }
    }
