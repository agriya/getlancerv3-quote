 ...
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend'.DS.'Validate'.DS.'Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once APP_PATH."/server/php/Slim/lib/vendors".DS."Youtube".DS.'Zend'.DS.'Validate'.DS.'Ip.php';
...
//        'CN'  => 'Hostname'.DS.'Cn.php',
//        'COM' => 'Zend'.DS.'Validate'.DS.'Hostname'.DS.'Com.php',
...
//        'HK'  => 'Zend'.DS.'Validate'.DS.'Hostname/Cn.php',
       ...
       // 'JP'  => 'Zend'.DS.'Validate'.DS.'Hostname/Jp.php',
       ...
       // 'NET' => 'Zend'.DS.'Validate'.DS.'Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
       // 'NU'  => 'Zend'.DS.'Validate'.DS.'Hostname/Com.php',
        ...
        //'TW'  => 'Zend'.DS.'Validate'.DS.'Hostname/Cn.php',
      ...
      //  '中国' => 'Zend'.DS.'Validate'.DS.'Hostname/Cn.php',
      //  '公司' => 'Zend'.DS.'Validate'.DS.'Hostname/Cn.php',
     //   '网络' => 'Zend'.DS.'Validate'.DS.'Hostname/Cn.php'
    );
